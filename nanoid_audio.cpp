...
void nanoid_audio_reinit() {
  // Re-registers I2S pins with the Audio library after mic has released them.
  if (!audioReady) return;
  delay(50); // brief settle after mic I2S teardown
  audio.setPinout(I2S_BCK_IO, I2S_WS_IO, I2S_DO_IO, I2S_MCK_IO);
  audio.setVolume(12);
  Serial.println("Audio pins reinitialized.");
}
