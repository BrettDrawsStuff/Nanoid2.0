...
├── location.cfg        ← Latitude and longitude for local weather (line 1: lat, line 2: lon)
...
### Personality
Edit `/personality.cfg` on the SD card to completely change how Nanoid speaks and behaves. No reuploading needed, changes take effect on next boot.
